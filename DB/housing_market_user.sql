...
<<<<<<< HEAD:DB/housing_market_user.sql
=======
...
CREATE TABLE `admin_user` (
  `ADMIN_ID` bigint(25) NOT NULL AUTO_INCREMENT,
  `ADMIN_NAME` varchar(11) NOT NULL COMMENT '名字',
...
>>>>>>> 6655372f9e8d6c6c58bddc39817e4fdfc5aad381:DB/housing_market.sql
--用户表

...
public class USER_SESSION_KEY implements java.io.Serializable {
	...
	/** default constructor */
	public USER_SESSION_KEY() {
	}

	/** minimal constructor */
	public USER_SESSION_KEY(String userName, Timestamp createTime) {
		this.userName = userName;
		this.createTime = createTime;
	}

	/** full constructor */
	public USER_SESSION_KEY(String userName, String password, String userImg,

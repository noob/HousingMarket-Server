...
<%@ page import="com.alipay.config2.*"%>
...
<html>
	...
	<%
		...
		//String msessionId = new String(request.getParameter("msessionId").getBytes("UTF-8"),"UTF-8");
		...
		//sParaTemp.put("extra_common_param", msessionId);

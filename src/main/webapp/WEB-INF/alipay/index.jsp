...
<body>
	<div class="header">
		...
		<div class="container">
			<div class="nav">
				<a href="https://www.alipay.com/" class="logo"><img
					src="img/alipay_logo.png" height="30px"></a> <span class="divier"></span>
				<a href="http://open.alipay.com/platform/home.htm" class="open"
					target="_blank">开放平台</a>
				<ul class="navbar">
					<li><a
						href="https://doc.open.alipay.com/doc2/detail?treeId=62&articleId=103566&docType=1"
						target="_blank">在线文档</a></li>
					<li><a
						href="https://cschannel.alipay.com/portal.htm?sourceId=213"
	...
	<div class="content">
     ...
     -->
		<form id="alipay_form" action="<%=path%>/alipay/submit_info" class="alipayform" method="POST">
			...
			<div class="element">
				<input type="submit" class="alisubmit pay" value="确认支付">
			</div>
		</form>
	</div>
	<div class="footer">
		<p class="footer-sub">
			...
			<a href="http://ab.alipay.com/i/jieshao.htm#en" target="_blank">About
				Alipay</a> <br> <span>支付宝版权所有</span> <span class="footer-date">2004-2016</span>
			<span><a href="http://fun.alipay.com/certificate/jyxkz.htm"
				target="_blank">ICP证：沪B2-20150087</a></span>
		</p>

		...
		<div class="tab-content">
			<div id="regist" class="tab-pane active">
				<form id="regist_form"  action="<%=path%>/login" class="form-signin" method="post">
					...
					<div>
						<input type="text" placeholder="请输入昵称" class="form-control userName" name="userName" />
						<div style="color:red; margin-top: 6px; height:15px;">
							<span id="regist_error_text_userName">&nbsp;&nbsp;昵称长度在3~20之间 </span>
						</div>
					</div>
					<div>
					...
					<div>
						<input type="password" placeholder="请确认密码" class="form-control password2" name="password2" />
						<div style="color:red; margin-top: 6px; height:15px;">
							<span id="regist_error_text_password2">&nbsp;&nbsp;两次密码不同 </span>
						</div>
					</div>
					<div style="width: 100%;">
						<button style="margin-top: 20px;width: 100%;" class="btn text-muted text-center btn-info regist" type="button" > 注册 </button>
					</div>
					<!-- 
					<div>
						 &nbsp;&nbsp;
